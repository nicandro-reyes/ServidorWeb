...
<!-- Pie de pagina-->
    ...
    <br><br><br><br><br><br>
    <h1 align="center">Inventario de Frutas</h1>
<br>
...
$tabla .= "<tr><th>ID</th><th>Fruta</th><th>Cantidad</th><th>Importe</th></tr>\n";
//Extraer fila a fila con un búcle while
while($row = mysqli_fetch_array($resultado))
  {
    echo "<tr><td width=\"15%\"><font face=\"verdana\"><h3>" . 
	    $row["codigo_fruta"] . "</h3></font></td>";
    echo "<td width=\"15%\"><font face=\"verdana\"><h3>" . 
	    $row["nombre_fruta"] . "</h3></font></td>";
    echo "<td width=\"15%\"><font face=\"verdana\"><h3>" . 
	    $row["cantidad"] . "</h3></font></td>";
    echo "<td width=\"15%\"><font face=\"verdana\"><h3>" . 
        $row["importe"]. "</h3></font></td>"; 
    echo "<td width=\"15%\"><font face=\"verdana\"><a href=modificar.php?id=".$row["codigo_fruta"].">modificar</a><h3></h3></font></td>";
